...
function Invoke-WPFFeatureInstall {
    ...
    if($sync.ProcessRunning) {
        ...
        [System.Windows.MessageBox]::Show($msg, "A-SYS", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Warning)
        return
    }
...
$sync.configs.appnavigation = @'
{
    ...
    "WPFActivationScripts":  {
                                 "Content":  "Activation scripts (online)",
                                 "Category":  "____Actions",
                                 "Type":  "Button",
                                 "Order":  "6",
                                 "Description":  "Opens a new PowerShell window and runs: irm https://get.activated.win | iex"
                             },
    "WPFToggleFOSSHighlight":  {
...
$sync.configs.tweaks = @'
{
    ...
    "WPFTweaksRestorePoint":  {
                                  ...
                                  "Description":  "Creates a restore point at runtime in case a revert is needed from A-SYS modifications.",
                                  "category":  "Essential",
                                  "panel":  "1",
                                  "Checked":  "False",
                                  "registry":  [
                                  ...
                                  "InvokeScript":  [
                                                       "\r\n      if (-not (Get-ComputerRestorePoint)) {\r\n          Enable-ComputerRestore -Drive $Env:SystemDrive\r\n      }\r\n\r\n      Checkpoint-Computer -Description \"System Restore Point created by A-SYS (Advance Systems 4042)\" -RestorePointType MODIFY_SETTINGS\r\n      Write-Host \"System Restore Point Created Successfully\" -ForegroundColor Green\r\n      "
                                                   ],
        ...
        <Grid Grid.Row="1" Background="{DynamicResource MainBackgroundColor}">
            ...
            <Grid Name="GridBesideNavDockPanel" Grid.Column="1" Background="{DynamicResource MainBackgroundColor}" ShowGridLines="False" Height="Auto">
                ...
                <StackPanel Grid.Column="1" Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Top" Margin="5,5,5,5">
                    ...
                    FontFamily="Segoe MDL2 Assets"
                    Content="N/A"
                    ToolTip="Change the A-SYS UI theme (Advance Systems 4042)"
                />
